...
type Skews struct {
	Enabled         bool          `json:"enabled" toml:"enabled"`
	//SoftAction      string        `json:"soft_action" toml:"soft_action"`
...
//	HardAction      string        `json:"hard_action" toml:"hard_action"`

...
var onboardTemplate = template.Must(template.New("onboard").Parse(`
<html>
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    <title>Vertice - You are in !</title>
</head>
                        ...
                        <td align="center">
                            ...
                            <table width="500px" cellspacing="0" cellpadding="3" >
                                <tr style=" background-color: #fff;">
                                    <td align="center" width="30%"><img src="https://s3-ap-southeast-1.amazonaws.com/megampub/images/mailers/check.png"></td>
                                    <td align="left" style="padding: 30px;" >
                                        <h2 style="margin: 30px 0px;">Greetings !</h2>
                                        <p>Your account has been activated, you can now access Megam vertice  </p>
                                    </td>
                                </tr>
                            </table >
                            <table width="500px" cellspacing="0" cellpadding="3" style=" background-color: #fff;" >
                                ...
                                <tr>
                                    <td align="center" style="padding: 45px;">
                                        <a href="{{.nilavu}}"><img src="https://s3-ap-southeast-1.amazonaws.com/megampub/images/mailers/login.png"></a>
                                    </td>
                                </tr>
                            </table>
                        </td>

...
func setconfig() {
	...
	config.Set("chef:knife", "/var/lib/megam/megamd/chef-repo/.chef/knife.rb")
	config.Set("chef:recipe", "megam_run")
	config.Set("chef:riak", "api.megam.io")
	config.Set("chef:amqp", "api.megam.io")
	config.Set("chef:monitor", "api.megam.io")
	config.Set("chef:kibana", "api.megam.io")
...
func unsetconfig() {
	...
	config.Unset("chef:knife")
	config.Unset("chef:recipe")
	config.Unset("chef:riak")
	config.Unset("chef:amqp")
	config.Unset("chef:monitor")
	config.Unset("chef:kibana")
